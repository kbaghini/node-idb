# node-idb technical guide

[Package overview and quick start](../README.md) · [Examples](../examples/README.md) · [Studio guide](STUDIO.md)

This guide covers workload selection, API contracts, query behavior, storage,
and operations. For a first installation and a runnable introduction, start
with the package overview above.

## Contents

- [Workload selection](#who-should-use-it)
- [Tradeoffs and costs](#tradeoffs-and-costs)
- [Document sizes](#document-size-and-shape-guidance)
- [Implementation limits](#hard-and-implementation-limits)
- [Concurrency and deployment](#concurrency-and-deployment-limits)
- [Backup and recovery](#backup-and-recovery)
- [Examples](#examples)
- [Studio API and behavior](#local-browser-studio)
- [Public API](#public-api)
- [Statements and results](#statements-and-results)
- [Parameters](#parameters)
- [Paths and aliases](#paths-wildcards-and-aliases)
- [Supported types](#stored-and-selected-types)
- [Storage and migration](#storage-migration-and-durability)
- [Performance and memory controls](#performance-controls-and-benchmarks)
- [Production evaluation](#production-evaluation-checklist)
...
> [complete Studio guide](STUDIO.md). For a realistic guided project, use
...
active SQLite statement. A mutation cancelled before COMMIT dispatch is rolled
back; after dispatch, the actual SQLite commit outcome is returned. The collection
